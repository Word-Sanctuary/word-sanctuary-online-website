...
const EventCard: React.FC<EventCardProps> = ({
  ...
  return (
    <div className={`w-96 bg-white rounded-2xl shadow-[0px_12px_32px_2px_rgba(0,0,0,0.12)] outline outline-1 outline-offset-[-1px] outline-blue-950/20 inline-flex flex-col justify-start items-start gap-4 overflow-hidden ${className}`}>
      {/* Event Image */}
      <div className="self-stretch h-96 relative bg-neutral-900 overflow-hidden">
        <Image
          src={image}
          alt={imageAlt}
          fill
      ...
      <div className="self-stretch px-4 pb-4 flex flex-col justify-start items-start gap-4">
        ...
        <div className="inline-flex justify-start items-end gap-2">
          <div className="justify-center text-black text-base font-bold font-lato">
            {title}
          </div>
        </div>
        ...
        <div className="self-stretch flex flex-col justify-start items-start gap-2">
          ...
          <div className="self-stretch inline-flex justify-start items-center gap-2">
            ...
            <div className="justify-center text-stone-500 text-sm font-normal font-lato tracking-wide">
              {date}
            </div>
          </div>
