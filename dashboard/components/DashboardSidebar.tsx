...
export default function DashboardSidebar({ user }: DashboardSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`
        fixed top-16 left-0 h-[calc(100vh-4rem)] w-64 bg-white border-r border-gray-200 z-40 transform transition-transform duration-300 ease-in-out
        ${isOpen ? 'translate-x-0' : '-translate-x-full'}
        lg:translate-x-0 lg:static lg:z-auto
      `}>
        <nav className="p-4 space-y-2">
          {/* User role indicator */}
          <div className="px-3 py-2 bg-gradient-to-r from-sky-50 to-sky-100 rounded-lg border border-sky-200 mb-4">
